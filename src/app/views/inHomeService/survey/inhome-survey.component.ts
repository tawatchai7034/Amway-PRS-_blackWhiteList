...
@Component({
  selector: 'app-inhome-survey',
  templateUrl: './inhome-survey.component.html',
  styleUrls: ['./inhome-survey.component.sass']
})
export class InhomeSurveyComponent implements OnInit {
