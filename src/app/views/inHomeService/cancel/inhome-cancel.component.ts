...
@Component({
  selector: 'app-inhome-cancel',
  templateUrl: './inhome-cancel.component.html',
  styleUrls: ['./inhome-cancel.component.sass']
})
export class InhomeCancelComponent implements OnInit {
