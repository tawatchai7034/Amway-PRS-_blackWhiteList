...
@Component({
  selector: 'app-inhome-edit',
  templateUrl: './inhome-edit.component.html',
  styleUrls: ['./inhome-edit.component.sass']
})
export class InhomeEditComponent implements OnInit {
...
constructor(
  ...
  onSave(){
    let validateData = [
      ...
      {
        format: "text",
        header: "วัน-เวลาที่สะดวกตอบกลับ",
