...
@Component({
  selector: 'app-receive-durable-view',
  templateUrl: './receive-durable-view.component.html',
  styleUrls: ['./receive-durable-view.component.sass']
})
export class ReceiveDurableViewComponent implements OnInit {
