...
@Component({
  selector: 'app-fault-new',
  templateUrl: './fault-new.component.html',
  styleUrls: ['./fault-new.component.sass']
})
export class FaultNewComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.dtOptions = { 
      ...
      [
        ...
        {data:"SKU",'targets': [1],title: "Part SKU",className:'center', width: "100px",},
        {data:"manMinute",'targets': [2],title: "Man-Minute",className:'center', width: "80px",},
        {data:"Qty",'targets': [3],title: "Qty",className:'center', width: "120px",},
        {data:"Cost",'targets': [4],title: "Cost",className:'center', width: "80px",},
        {data:"Start",'targets': [5],title: "Effective Start",className:'center', width: "50px",},
        {data:"End",'targets': [6],title: "Effective End",className:'center', width: "50px",},
        {data:"des",'targets': [7],title: "Description",className:'left', width: "208px",}, 
    ]
    };
